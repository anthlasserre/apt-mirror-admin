  ...
  <body>
    ...
    <div id="content">
      ...
      <div id="installationClient">
        ...
        <p id="code">nano /etc/apt/sources.list</p>
        ...
        <p id="code">deb http://192.168.0.31/debian jessie main contrib non-free</p>
        <p><ul><li>Et voilà, vous n’avez plus qu’à mettre à jour vos paquets premièrement</p></li></ul>
        <p id="code">apt-get update</p>
      ...
      <div id="installationServeur">
        ...
        <p id="code">deb http://ftp.fr.debian.org/debian jessie main contrib non-free<br>
        ...
        <p id="code">0 20    * * *   root    /usr/bin/apt-mirror > /srv/apt-mirror/var/cron.log</p>
        ...
        <p id="code">aptitude install apache2</p>
        <p><ul><li>Modifier le fichier /etc/apache2/apache2.conf.</p></li></ul>
        <p id="code">nano /etc/apache2/apache2.conf</p>
        <p><ul><li>Modifier cette partie du fichier, comme tel.</p></li></ul>
        <p id="code">&lt;Directory /srv/www/&gt;<br>&nbsp;Options Indexes FollowSymlinks<br>&nbsp;AllowOverride All<br>&nbsp;Require all granted</p>
        <p><ul><li>Modifier /etc/apache2/sites-available/000-default.conf en mettant: </p></li></ul>
        <p id="code">DocumentRoot&nbsp;/srv/www</p>
        <p><ul><li>Enfin, faisons les liens symboliques du dépôt des paquets, vers notre serveur internet.</p></li></ul>
        <p id="code">ln -s /srv/apt-mirror/mirror/ftp.fr.debian.org/debian/ /srv/www<br>ln -s /srv/apt-mirrror/mirror/security.debian.org/ /var/www/secudebian
